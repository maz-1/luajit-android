...
do
    ...
    *)
    ...
    if [[ -f $_basedir/lock ]] ; then
        [[ -f $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lxp.so ]] && continue
    fi
    ...
    cd $_basedir/build
    make PREFIX=/system LUA_INC="" EXPAT_INC="" || break
    

    rm -rf $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lxp.so $_basedir/../_BINARY/${ARCH}/share/lua/${LUA_VERSION}/lxp
    mkdir -p $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/ $_basedir/../_BINARY/${ARCH}/share/lua/${LUA_VERSION}/lxp
    cp ./src/lxp.so $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lxp.so
    ${_CROSS_COMPILE}-strip $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lxp.so
    cp -r src/lxp/*.lua $_basedir/../_BINARY/${ARCH}/share/lua/${LUA_VERSION}/lxp/
