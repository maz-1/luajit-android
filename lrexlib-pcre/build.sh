...
do
    ...
    *)
    ...
    if [[ -f $_basedir/lock ]] ; then
        [[ -f $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/rex_pcre.so ]] && continue
    fi
    ...
    rm -f $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/rex_pcre.so
    mkdir -p $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/
    cp ./rex_pcre.so $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/rex_pcre.so
    ${CROSS_COMPILE}-strip $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/rex_pcre.so
