...
do
    ...
    *)
    ...
    if [[ -f $_basedir/lock ]] ; then
        [[ -f $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lanes/core.so ]] && continue
    fi
    ...
    export LDFLAGS="--sysroot=${PLATFORM}/arch-${ARCH} -g -O2 -fPIC -lz -lm"
    ...
    rm -f $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lanes/core.so 
    mkdir -p $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lanes $_basedir/../_BINARY/${ARCH}/share/lua/${LUA_VERSION}/
    cp ./core.so $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lanes/core.so
    ${CROSS_COMPILE}-strip $_basedir/../_BINARY/${ARCH}/lib/lua/${LUA_VERSION}/lanes/core.so
    cat $_basedir/src/src/lanes.lua > $_basedir/../_BINARY/${ARCH}/share/lua/${LUA_VERSION}/lanes.lua
    rm $_basedir/lock
